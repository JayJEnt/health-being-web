...
import {
	type Preference,
	Preference as PreferenceValues,
...
type Props = {
	...
	setPreferedIngredients: Dispatch<
		SetStateAction<IngredientPreferenceResponse[]>
	>;
};
					...
					{preferedIngredients.map((ingredient) => (
						...
						>
							...
							<button
								type="button"
								onClick={() =>
									void removePreferedIngredient(ingredient.ingredient_id)
								}
