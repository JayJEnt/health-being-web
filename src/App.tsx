...
import ForgotPasswordPage from "./pages/authorization/ForgotPassword.tsx";
...
import PasswordCallbackPage from "./pages/callback/PasswordCallback.tsx";
		...
		<div className="grid grid-cols-[auto_1fr] gap-4 min-h-screen">
			...
			<main className="pt-16 absolute inset-0">
				<Routes>
					...
					<Route path="/password_callback" element={<PasswordCallbackPage />} />
