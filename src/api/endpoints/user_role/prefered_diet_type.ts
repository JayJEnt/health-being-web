...
export const preferedDietTypeApi = {
  getById: (diet_type_id: number) =>
    api.get<PreferedRecipeTypeResponse>(`${settings.PREFERED_DIET_TYPES_ENDPOINT}`, { diet_type_id }),
  ...
  delete: (diet_type_id: number) =>
    api.delete<PreferedRecipeTypeDelete>(`${settings.PREFERED_DIET_TYPES_ENDPOINT}`, { diet_type_id }),
};