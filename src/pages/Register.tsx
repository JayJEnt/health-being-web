        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex justify-center">
            <button
              type="button"
              onClick={() => {
                  // navigate to backend OAuth2 Google start endpoint so server can redirect to Google
                  // backend router expects /oauth2_ with query param external_provider=google
                  window.location.href = `${settings.API_BASE_URL}/oauth2_?external_provider=google`;
                }}
              className="mt-2 bg-red-600 hover:bg-red-500 text-white py-2 px-4 rounded-xl transition"
            >
