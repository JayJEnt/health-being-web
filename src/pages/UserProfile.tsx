...
// 				setPersonalData(
// 					pd ??
// 						makeDefaultPersonalData(user.id, user.name, user.email, user.role),
// 				);
...
// 		void load();
// 	}, [user?.id, makeDefaultPersonalData, user.email, user.name, user.role]);
...
// 						setData(
// 							"silhouette",
// 							e.target.value ? (e.target.value as Silhouette) : null,
// 						)
// 					}
// 					className="w-full border px-3 py-2 rounded"
// 				>
